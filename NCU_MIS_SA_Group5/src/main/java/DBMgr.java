...
public class DBMgr {
    ...
    //static final String DB_URL = "jdbc:mysql://localhost:3307/missa";
    static final String DB_URL = "jdbc:mysql://localhost:3306/group5_final?zeroDateTimeBehavior=convertToNull";
